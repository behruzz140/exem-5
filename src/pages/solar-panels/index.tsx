...
<svg width="380px" height="500px" viewBox="0 0 837 1045" version="1.1" xmlns="http://www.w3.org/2000/svg" href="http://www.w3.org/1999/xlink" type="http://www.bohemiancoding.com/sketch/ns">
...
<div className="message-box">
  ...
  <p><span className='text-yellow-500 text-[20px]'>Solar Panel</span> not found</p>
  <div className="buttons-con">
    <div className="action-link-wrap">
      {/* <a onClick="history.back(-1)" className="link-button link-back-button">Go Back</a> */}
     
	
	  <a href='https://www.tesla.com/solarpanels' className="link-button">More About Panel</a>
    </div>
  </div>
</div>
    </>
